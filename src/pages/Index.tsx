...
import { meditationData, getRandomMeditations } from '@/data/meditationData';
import { getLottieAnimation } from '@/data/lottieAnimations';

// Get a subset of meditation tracks for the main page
const meditationTracks = getRandomMeditations(20);
    ...
    <div className="flex flex-col h-screen">
      ...
      >
        ...
        <div className="mt-8 flex flex-col items-center justify-center px-4">
          ...
          {/* Circular Image with Lottie Animation - adjusted to be fully visible */}
          <div className="relative mb-10">
            <div className="w-48 h-48 rounded-full bg-white p-2 shadow-lg">
              <div className="w-full h-full rounded-full overflow-hidden relative">
                ...
                {currentTrack.lottieAnimation && (
                  <div className="absolute inset-0 flex items-center justify-center">
                    <LottieAnimation
                      animationData={getLottieAnimation(currentTrack.lottieAnimation)}
