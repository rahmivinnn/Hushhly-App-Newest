...
const Profile: React.FC = () => {
  ...
  const [recentSessions, setRecentSessions] = useState<RecentSession[]>([
    ...
    },
    {
      ...
      date: "Earlier this week, 10:15 AM",
      duration: "12 min",
      type: "Breathing",
      completed: true
    }
  ...
  const [achievements, setAchievements] = useState<Achievement[]>([
    ...
    },
    {
      id: "fresh_sync",
      title: "Fresh Sync",
      icon: <Check className="text-teal-500" size={28} />,
      color: "bg-teal-100",
      completed: true,
      description: "Profile and meditation data synced just now"
    },
    {
      id: "calm_champion",
      title: "Calm Champion",
      ...
      color: "bg-pink-100",
      completed: true,
      description: "Earned for consistent practice this week"
    }
  ]);
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="relative">
        ...
        {/* Last Sync Indicator */}
        <div className="absolute top-2 left-2 flex items-center text-xs text-green-700 bg-green-50 px-2 py-1 rounded-full border border-green-200">
